...
execute_process(
  COMMAND "/usr/bin/git" --git-dir=.git show-ref "fe858f7"
  WORKING_DIRECTORY "/home/runner/work/CNC_machine_Proj/CNC_machine_Proj/_codeql_build_dir/_deps/core-src"
...
elseif(show_ref_output MATCHES "^[a-z0-9]+[ \\t]+refs/tags/")
  ...
  get_hash_for_ref("fe858f7" tag_sha error_msg)
  if(tag_sha STREQUAL head_sha)
    message(VERBOSE "Already at requested tag: fe858f7")
    return()
  endif()
...
elseif(show_ref_output MATCHES "^[a-z0-9]+[ \\t]+refs/heads/")
  ...
  set(checkout_name "origin/fe858f7")
  ...
  elseif(tag_sha STREQUAL "")
    ...
    if(NOT can_fetch)
      message(FATAL_ERROR
        "Requested git ref \"fe858f7\" is not present locally, and not "
...
if(git_update_strategy STREQUAL "CHECKOUT")
  ...
  if(error_code)
    ...
    if(NOT git_update_strategy STREQUAL "REBASE_CHECKOUT")
      ...
      message(FATAL_ERROR "\nFailed to rebase in: '/home/runner/work/CNC_machine_Proj/CNC_machine_Proj/_codeql_build_dir/_deps/core-src'."
...
if(need_stash)
  ...
  if(error_code)
    ...
    if(error_code)
      ...
      message(FATAL_ERROR "\nFailed to unstash changes in: '/home/runner/work/CNC_machine_Proj/CNC_machine_Proj/_codeql_build_dir/_deps/core-src'."
                          "\nYou will have to resolve the conflicts manually")
    endif()
  endif()
endif()
